# -*- coding: utf-8 -*-
"""
Created on Sun Jul 23 21:04:20 2023
...
def _detect_blobs(
    ...
    **kwargs,
    ...
    all_coords = []
    all_sigmas = []
    for index in np.ndindex(10):
        full_index = index + feature_slices
        indexed_image_data = data[index]
        coords = method(indexed_image_data.astype(float), **kwargs)
        for c in coords:
    ...
    state = {
        'name': f'image-features-{method.__name__}',
